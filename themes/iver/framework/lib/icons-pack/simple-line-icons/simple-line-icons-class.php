...
class IverSelectSimpleLineIcons implements iIverSelectIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'iver'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'iver'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'iver'),
            'icon-social-facebook'    => esc_html__('Facebook', 'iver'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'iver'),
            'icon-social-github'      => esc_html__('Github', 'iver'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'iver'),
            'icon-social-instagram'   => esc_html__('Instagram', 'iver'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'iver'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'iver'),
            'icon-social-reddit'      => esc_html__('Reddit', 'iver'),
            'icon-social-skype'       => esc_html__('Skype', 'iver'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'iver'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'iver'),
            'icon-social-spotify'     => esc_html__('Spotify', 'iver'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'iver'),
            'icon-social-twitter'     => esc_html__('Twitter', 'iver'),
            'icon-social-youtube'     => esc_html__('Youtube', 'iver')
        );
    }
