...
if( !function_exists('iver_select_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function iver_select_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'iver_select_blog_single_holder_classes', 'iver_select_get_blog_single_holder_classes' );
}
