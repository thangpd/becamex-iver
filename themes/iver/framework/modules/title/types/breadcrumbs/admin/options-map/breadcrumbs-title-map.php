...
if ( ! function_exists('iver_select_breadcrumbs_title_type_options_map') ) {
	function iver_select_breadcrumbs_title_type_options_map($panel_typography) {
		
		iver_select_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'iver' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = iver_select_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'iver' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'iver' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = iver_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = iver_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = iver_select_add_admin_row(
				array(
	...
	add_action( 'iver_select_additional_title_typography_options_map', 'iver_select_breadcrumbs_title_type_options_map');
}