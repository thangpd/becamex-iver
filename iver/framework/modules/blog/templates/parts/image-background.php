...
$blog_list_image_id = ! empty( $image_meta ) && iver_select_blog_item_has_link() ? iver_select_get_attachment_id_from_url( $image_meta ) : '';
$background_image   = '';
...
?>
<?php if ( $has_featured ) { ?>
	<div class="qodef-post-image-background" <?php iver_select_inline_style($background_image); ?>>
