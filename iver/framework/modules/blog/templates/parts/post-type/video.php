		    ...
		    <div class="qodef-video-wrap">
			    <video class="qodef-self-hosted-video" poster="<?php echo esc_url( $videoimage ); ?>" preload="auto">
				    ...
				    <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_url( $flashmedia ); ?>">
					    ...
					    <img itemprop="image" src="<?php echo esc_url( $videoimage ); ?>" width="1920" height="800" title="<?php esc_attr_e( 'No video playback capabilities', 'iver' ); ?>" alt="<?php esc_attr_e( 'Video Thumb', 'iver' ); ?>"/>
				    </object>
			    </video>
		    </div>
	    </div>
