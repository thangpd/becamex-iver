...
if ( ! function_exists('iver_select_contact_form_7_options_map') ) {

	function iver_select_contact_form_7_options_map() {
		
		iver_select_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'iver' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = iver_select_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'iver' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = iver_select_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'iver' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'iver' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = iver_select_add_admin_row(
			array(
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'iver' ),
			)
		);
		...
		$typography_text_row2 = iver_select_add_admin_row(
			array(
		...
		$typography_text_row3 = iver_select_add_admin_row(
			array(
		...
		$typography_label_group = iver_select_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'iver' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'iver' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = iver_select_add_admin_row(
			array(
		...
		$typography_label_row2 = iver_select_add_admin_row(
			array(
		...
		$background_border_group = iver_select_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'iver' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'iver' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = iver_select_add_admin_row(
			array(
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'iver' )
			)
		);
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'iver' )
			)
		);
		
		$background_border_row2 = iver_select_add_admin_row(
			array(
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'iver' ),
			)
		);
		...
		iver_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'iver' )
			)
		);
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'iver' )
			)
		);
		
		$background_border_row3 = iver_select_add_admin_row(
			array(
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'iver' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'iver' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = iver_select_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'iver' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = iver_select_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'iver' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'iver' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'iver' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'iver' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = iver_select_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'iver' ),
				'description' => esc_html__( 'Setup form elements margin', 'iver' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = iver_select_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'iver' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'iver' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = iver_select_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'iver' ),
				'description' => esc_html__( 'Setup button text typography', 'iver' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = iver_select_add_admin_row(
			array(
		...
		$button_typography_row2 = iver_select_add_admin_row(
			array(
		...
		$button_background_border_group = iver_select_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'iver' ),
				'description' => esc_html__( 'Setup button background and border style', 'iver' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = iver_select_add_admin_row(
			array(
		...
		iver_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'iver' )
			)
		);
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'iver' )
			)
		);
		
		$button_background_border_row2 = iver_select_add_admin_row(
			array(
		...
		iver_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'iver' )
			)
		);
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'iver' )
			)
		);
		
		$button_background_border_row3 = iver_select_add_admin_row(
			array(
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'iver' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		iver_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'iver' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = iver_select_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'iver')
		));

		//Text Typography

		$typography_text_group = iver_select_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'iver'),
			'description'	=> esc_html__('Setup typography for form elements text', 'iver'),
		...
		$typography_text_row1 = iver_select_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = iver_select_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = iver_select_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = iver_select_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'iver'),
			'description'	=> esc_html__('Setup typography for form elements label', 'iver'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = iver_select_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = iver_select_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = iver_select_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'iver'),
			'description'	=> esc_html__('Setup form elements background and border style', 'iver'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = iver_select_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = iver_select_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = iver_select_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = iver_select_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'iver'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = iver_select_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = iver_select_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'iver'),
			'description'	=> esc_html__('Setup form elements margin', 'iver'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = iver_select_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = iver_select_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'iver'),
			'description'	=> esc_html__('Setup button text typography', 'iver'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = iver_select_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = iver_select_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = iver_select_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'iver'),
			'description'	=> esc_html__('Setup button background and border style', 'iver'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = iver_select_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = iver_select_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = iver_select_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = iver_select_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'iver')
        ));
        ...
        $typography_label_row3 = iver_select_add_admin_row(array(
        ...
        $button_typography_row3 = iver_select_add_admin_row(array(
	...
	add_action( 'iver_select_options_map', 'iver_select_contact_form_7_options_map', 20);
}